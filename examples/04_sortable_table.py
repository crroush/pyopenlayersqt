...
def main():
    ...
    # Add sample data
    table1.append_rows([
        {"layer_id": "1", "feature_id": "a", "id": "003", "name": "Charlie", "value": 150, "timestamp": "2024-01-15T10:30:00Z"},
        {"layer_id": "1", "feature_id": "b", "id": "001", "name": "Alice", "value": 100, "timestamp": "2024-01-10T08:00:00Z"},
        {"layer_id": "1", "feature_id": "c", "id": "002", "name": "Bob", "value": 200, "timestamp": "2024-01-20T15:45:00Z"},
    ])
    
    # Example 2: Table with some non-sortable columns
    table2 = FeatureTableWidget(
        columns=[
