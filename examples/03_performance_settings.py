...
def main():
    ...
    default_style = FastPointsStyle(
        ...
        skip_rendering_while_interacting=True,  # Skip rendering during pan/zoom if >100 points
        max_points_while_interacting=5000,      # Max points to render during interaction
    )
    ...
    always_render_style = FastPointsStyle(
        ...
        skip_rendering_while_interacting=False,  # Always render, even during interaction
        max_points_while_interacting=999999,     # Effectively unlimited
    )
    ...
    print("- Default: skip_rendering_while_interacting=True, max_points_while_interacting=5000")
    print("  During pan/zoom with >100 points: rendering is skipped for smooth interaction")
    print("  Points reappear when you stop moving the map")
