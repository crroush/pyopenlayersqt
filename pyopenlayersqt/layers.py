...
class VectorLayer(BaseLayer):
    ...
    def add_icon_points(
        ...
        Args:
            coords: Sequence of (lat, lon) tuples for each point.
            icon: HTTP(S) URL, local image path, data URI, bytes, bytearray,
                memoryview, or QByteArray. Local files and bytes-like values are
                cached and served automatically to the embedded browser.
